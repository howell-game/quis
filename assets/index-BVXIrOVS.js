const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Policies-D1jEeLZE.js","./Policies-B07RryjC.css","./QuestionCarousel-BKy5wk_P.js","./html2canvas.esm-BqxxR2q2.js","./QuestionCarousel-4VP3xEK9.css","./Competition-ChLZ-96Q.js","./Competition-BibY438W.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jA="firebase-heartbeat-database",HA=1,ao="firebase-heartbeat-store";let Rl=null;function m_(){return Rl||(Rl=d_(jA,HA,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ao)}catch(n){console.warn(n)}}}}).catch(t=>{throw Ar.create("idb-open",{originalErrorMessage:t.message})})),Rl}async function zA(t){try{const n=(await m_()).transaction(ao),r=await n.objectStore(ao).get(g_(t));return await n.done,r}catch(e){if(e instanceof En)Zn.warn(e.message);else{const n=Ar.create("idb-get",{originalErrorMessage:e?.message});Zn.warn(n.message)}}}async function Kd(t,e){try{const r=(await m_()).transaction(ao,"readwrite");await r.objectStore(ao).put(e,g_(t)),await r.done}catch(n){if(n instanceof En)Zn.warn(n.message);else{const r=Ar.create("idb-set",{originalErrorMessage:n?.message});Zn.warn(r.message)}}}function g_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XA(t){On(new _n("platform-logger",e=>new uA(e),"PRIVATE")),On(new _n("heartbeat",e=>new GA(e),"PRIVATE")),sn(ou,zd,t),sn(ou,zd,"esm2020"),sn("fire-js","")}XA("");var Yd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ep="__name__";class In{constructor(e,n,r){n===void 0?n=0:n>e.length&&ue(637,{offset:n,range:e.length}),r===void 0?r=e.length-n:r>e.length-n&&ue(1746,{length:r,range:e.length-n}),this.segments=e,this.offset=n,this.len=r}get length(){return this.len}isEqual(e){return In.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof In?e.forEach(r=>{n.push(r)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,r=this.limit();n<r;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const r=Math.min(e.length,n.length);for(let s=0;s<r;s++){const i=In.compareSegments(e.get(s),n.get(s));if(i!==0)return i}return Re(e.length,n.length)}static compareSegments(e,n){const r=In.isNumericId(e),s=In.isNumericId(n);return r&&!s?-1:!r&&s?1:r&&s?In.extractNumericId(e).compare(In.extractNumericId(n)):uu(e,n)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return br.fromString(e.substring(4,e.length-2))}}class ze extends In{construct(e,n,r){return new ze(e,n,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const n=[];for(const r of e){if(r.indexOf("//")>=0)throw new J(M.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);n.push(...r.split("/").filter(s=>s.length>0))}return new ze(n)}static emptyPath(){return new ze([])}}const cb=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class _t extends In{construct(e,n,r){return new _t(e,n,r)}static isValidIdentifier(e){return cb.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),_t.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===ep}static keyField(){return new _t([ep])}static fromServerFormat(e){const n=[];let r="",s=0;const i=()=>{if(r.length===0)throw new J(M.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(r),r=""};let o=!1;for(;s<e.length;){const c=e[s];if(c==="\\"){if(s+1===e.length)throw new J(M.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const l=e[s+1];if(l!=="\\"&&l!=="."&&l!=="`")throw new J(M.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);r+=l,s+=2}else c==="`"?(o=!o,s++):c!=="."||o?(r+=c,s++):(i(),s++)}if(i(),o)throw new J(M.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new _t(n)}static emptyPath(){return new _t([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e){this.fields=e,e.sort(_t.comparator)}static empty(){return new Qt([])}unionWith(e){let n=new ct(_t.comparator);for(const r of this.fields)n=n.add(r);for(const r of e)n=n.add(r);return new Qt(n.toArray())}covers(e){for(const n of this.fields)if(n.isPrefixOf(e))return!0;return!1}isEqual(e){return zs(this.fields,e.fields,(n,r)=>n.isEqual(r))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dh{constructor(){this.Qr=new ct(lt.$r),this.Ur=new ct(lt.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(e,n){const r=new lt(e,n);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Gr(new lt(e,n))}zr(e,n){e.forEach(r=>this.removeReference(r,n))}jr(e){const n=new oe(new ze([])),r=new lt(n,e),s=new lt(n,e+1),i=[];return this.Ur.forEachInRange([r,s],o=>{this.Gr(o),i.push(o.key)}),i}Jr(){this.Qr.forEach(e=>this.Gr(e))}Gr(e){this.Qr=this.Qr.delete(e),this.Ur=this.Ur.delete(e)}Hr(e){const n=new oe(new ze([])),r=new lt(n,e),s=new lt(n,e+1);let i=Se();return this.Ur.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const n=new lt(e,0),r=this.Qr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class lt{constructor(e,n){this.key=e,this.Yr=n}static $r(e,n){return oe.comparator(e.key,n.key)||Re(e.Yr,n.Yr)}static Kr(e,n){return Re(e.Yr,n.Yr)||oe.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Js(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof En&&IC(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function IC({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hr(t,e){le(typeof t=="string"||typeof t>"u","internal-error",{appName:e})}class fn{constructor({uid:e,auth:n,stsTokenManager:r,...s}){this.providerId="firebase",this.proactiveRefresh=new AC(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=n,this.stsTokenManager=r,this.accessToken=r.accessToken,this.displayName=s.displayName||null,this.email=s.email||null,this.emailVerified=s.emailVerified||!1,this.phoneNumber=s.phoneNumber||null,this.photoURL=s.photoURL||null,this.isAnonymous=s.isAnonymous||!1,this.tenantId=s.tenantId||null,this.providerData=s.providerData?[...s.providerData]:[],this.metadata=new Cu(s.createdAt||void 0,s.lastLoginAt||void 0)}async getIdToken(e){const n=await Js(this,this.stsTokenManager.getToken(this.auth,e));return le(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return TC(this,e)}reload(){return bC(this)}_assign(e){this!==e&&(le(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>({...n})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new fn({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return n.metadata._copy(this.metadata),n}_onReload(e){le(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),n&&await Ja(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Ut(this.auth.app))return Promise.reject(Nn(this.auth));const e=await this.getIdToken();return await Js(this,wC(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){const r=n.displayName??void 0,s=n.email??void 0,i=n.phoneNumber??void 0,o=n.photoURL??void 0,c=n.tenantId??void 0,l=n._redirectEventId??void 0,u=n.createdAt??void 0,f=n.lastLoginAt??void 0,{uid:p,emailVerified:m,isAnonymous:_,providerData:S,stsTokenManager:N}=n;le(p&&N,e,"internal-error");const V=Bs.fromJSON(this.name,N);le(typeof p=="string",e,"internal-error"),hr(r,e.name),hr(s,e.name),le(typeof m=="boolean",e,"internal-error"),le(typeof _=="boolean",e,"internal-error"),hr(i,e.name),hr(o,e.name),hr(c,e.name),hr(l,e.name),hr(u,e.name),hr(f,e.name);const j=new fn({uid:p,auth:e,email:s,emailVerified:m,displayName:r,isAnonymous:_,photoURL:o,phoneNumber:i,tenantId:c,stsTokenManager:V,createdAt:u,lastLoginAt:f});return S&&Array.isArray(S)&&(j.providerData=S.map(q=>({...q}))),l&&(j._redirectEventId=l),j}static async _fromIdTokenResponse(e,n,r=!1){const s=new Bs;s.updateFromServerResponse(n);const i=new fn({uid:n.localId,auth:e,stsTokenManager:s,isAnonymous:r});return await Ja(i),i}static async _fromGetAccountInfoResponse(e,n,r){const s=n.users[0];le(s.localId!==void 0,"internal-error");const i=s.providerUserInfo!==void 0?ev(s.providerUserInfo):[],o=!(s.email&&s.passwordHash)&&!i?.length,c=new Bs;c.updateFromIdToken(r);const l=new fn({uid:s.localId,auth:e,stsTokenManager:c,isAnonymous:o}),u={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:i,metadata:new Cu(s.createdAt,s.lastLoginAt),isAnonymous:!(s.email&&s.passwordHash)&&!i?.length};return Object.assign(l,u),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W0=new Oo(3e4,6e4);function um(){const t=Dn().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function K0(t){return new Promise((e,n)=>{function r(){um(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{um(),n(mn(t,"network-request-failed"))},timeout:W0.get()})}if(Dn().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(Dn().gapi?.load)r();else{const s=UC("iframefcb");return Dn()[s]=()=>{gapi.load?r():n(mn(t,"network-request-failed"))},hv(`${FC()}?onload=${s}`).catch(i=>n(i))}}).catch(e=>{throw Ra=null,e})}let Ra=null;function G0(t){return Ra=Ra||K0(t),Ra}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gP(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function _P(t){On(new _n("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;le(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:uv(t)},u=new xC(r,s,i,l);return zC(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),On(new _n("auth-internal",e=>{const n=Mn(e.getProvider("auth").getImmediate());return(r=>new mP(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),sn(dm,pm,gP(t)),sn(dm,pm,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yv="installations",o1="installations-internal",a1=t=>{const e=t.getProvider("app").getImmediate(),n=i1(e),r=gs(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},c1=t=>{const e=t.getProvider("app").getImmediate(),n=gs(e,Yv).getImmediate();return{getId:()=>n1(n),getToken:s=>r1(n,s)}};function l1(){On(new _n(Yv,a1,"PUBLIC")),On(new _n(o1,c1,"PRIVATE"))}l1();sn(Vv,Jh);sn(Vv,Jh,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class M1{constructor(e){this.app=e}_delete(){return delete Ji[this.app.options.appId],Promise.resolve()}}let Ji={},ym=[];const vm={};let Fl="dataLayer",L1="gtag",Em,eE,wm=!1;function F1(){const t=[];if(c_()&&t.push("This is a browser extension environment."),OI()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,s)=>`(${s+1}) ${r}`).join(" "),n=Yt.create("invalid-analytics-context",{errorInfo:e});Ht.warn(n.message)}}function U1(t,e,n){F1();const r=t.options.appId;if(!r)throw Yt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)Ht.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Yt.create("no-api-key");if(Ji[r]!=null)throw Yt.create("already-exists",{id:r});if(!wm){y1(Fl);const{wrappedGtag:i,gtagCore:o}=T1(Ji,ym,vm,Fl,L1);eE=i,Em=o,wm=!0}return Ji[r]=x1(t,ym,vm,e,Em,Fl,n),new M1(t)}function $1(t=Zu()){t=Ye(t);const e=gs(t,nc);return e.isInitialized()?e.getImmediate():B1(t)}function B1(t,e={}){const n=gs(t,nc);if(n.isInitialized()){const s=n.getImmediate();if(Xn(e,n.getOptions()))return s;throw Yt.create("already-initialized")}return n.initialize({options:e})}function q1(t,e,n,r){t=Ye(t),V1(eE,Ji[t.app.options.appId],e,n,r).catch(s=>Ht.error(s))}const Tm="@firebase/analytics",Im="0.10.18";function j1(){On(new _n(nc,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return U1(r,s,n)},"PUBLIC")),On(new _n("analytics-internal",t,"PRIVATE")),sn(Tm,Im),sn(Tm,Im,"esm2020");function t(e){try{const n=e.getProvider(nc).getImmediate();return{logEvent:(r,s,i)=>q1(n,r,s,i)}}catch(n){throw Yt.create("interop-component-reg-failed",{reason:n})}}}j1();const H1={apiKey:"AIzaSyB9_6M0plpGAegqzVp1uOouqAVUbry9sqM",authDomain:"howwell-game.firebaseapp.com",projectId:"howwell-game",storageBucket:"howwell-game.firebasestorage.app",messagingSenderId:"26663870324",appId:"1:26663870324:web:d2655b10ba2d62f9701621",measurementId:"G-1VNBQ93JGN"},nf=p_(H1),at=wP(nf),Ae=GS(nf);new nn;typeof window<"u"&&$1(nf);const tE=we(null),z1=ui(at,t=>{tE.value=t});Ms(()=>z1());function W1(){return{user:tE}}/*!
  ...
  */const ks=typeof document<"u";function nE(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function K1(t){return t.__esModule||t[Symbol.toStringTag]==="Module"||t.default&&nE(t.default)}const Ve=Object.assign;function Ul(t,e){const n={};for(const r in e){const s=e[r];n[r]=vn(s)?s.map(t):t(s)}return n}const Xi=()=>{},vn=Array.isArray,rE=/#/g,G1=/&/g,Q1=/\//g,Y1=/=/g,J1=/\?/g,sE=/\+/g,X1=/%5B/g,Z1=/%5D/g,iE=/%5E/g,ek=/%60/g,oE=/%7B/g,tk=/%7C/g,aE=/%7D/g,nk=/%20/g;function rf(t){return encodeURI(""+t).replace(tk,"|").replace(X1,"[").replace(Z1,"]")}function rk(t){return rf(t).replace(oE,"{").replace(aE,"}").replace(iE,"^")}function Du(t){return rf(t).replace(sE,"%2B").replace(nk,"+").replace(rE,"%23").replace(G1,"%26").replace(ek,"`").replace(oE,"{").replace(aE,"}").replace(iE,"^")}function sk(t){return Du(t).replace(Y1,"%3D")}function ik(t){return rf(t).replace(rE,"%23").replace(J1,"%3F")}function ok(t){return t==null?"":ik(t).replace(Q1,"%2F")}function vo(t){try{return decodeURIComponent(""+t)}catch{}return""+t}const ak=/\/$/,ck=t=>t.replace(ak,"");function $l(t,e,n="/"){let r,s={},i="",o="";const c=e.indexOf("#");let l=e.indexOf("?");return c<l&&c>=0&&(l=-1),l>-1&&(r=e.slice(0,l),i=e.slice(l+1,c>-1?c:e.length),s=t(i)),c>-1&&(r=r||e.slice(0,c),o=e.slice(c,e.length)),r=fk(r??e,n),{fullPath:r+(i&&"?")+i+o,path:r,query:s,hash:vo(o)}}function lk(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Am(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function uk(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Xs(e.matched[r],n.matched[s])&&cE(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Xs(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function cE(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!hk(t[n],e[n]))return!1;return!0}function hk(t,e){return vn(t)?bm(t,e):vn(e)?bm(e,t):t===e}function bm(t,e){return vn(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function fk(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,o,c;for(o=0;o<r.length;o++)if(c=r[o],c!==".")if(c==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(o).join("/")}const fr={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var Eo;(function(t){t.pop="pop",t.push="push"})(Eo||(Eo={}));var Zi;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Zi||(Zi={}));function dk(t){if(!t)if(ks){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),ck(t)}const pk=/^[^#]+#/;function mk(t,e){return t.replace(pk,"#")+e}function gk(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Kc=()=>({left:window.scrollX,top:window.scrollY});function _k(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=gk(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function Rm(t,e){return(history.state?history.state.position-e:-1)+t}const Vu=new Map;function yk(t,e){Vu.set(t,e)}function vk(t){const e=Vu.get(t);return Vu.delete(t),e}let Ek=()=>location.protocol+"//"+location.host;function lE(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let c=s.includes(t.slice(i))?t.slice(i).length:1,l=s.slice(c);return l[0]!=="/"&&(l="/"+l),Am(l,"")}return Am(n,t)+r+s}function wk(t,e,n,r){let s=[],i=[],o=null;const c=({state:m})=>{const _=lE(t,location),S=n.value,N=e.value;let V=0;if(m){if(n.value=_,e.value=m,o&&o===S){o=null;return}V=N?m.position-N.position:0}else r(_);s.forEach(j=>{j(n.value,S,{delta:V,type:Eo.pop,direction:V?V>0?Zi.forward:Zi.back:Zi.unknown})})};function l(){o=n.value}function u(m){s.push(m);const _=()=>{const S=s.indexOf(m);S>-1&&s.splice(S,1)};return i.push(_),_}function f(){const{history:m}=window;m.state&&m.replaceState(Ve({},m.state,{scroll:Kc()}),"")}function p(){for(const m of i)m();i=[],window.removeEventListener("popstate",c),window.removeEventListener("beforeunload",f)}return window.addEventListener("popstate",c),window.addEventListener("beforeunload",f,{passive:!0}),{pauseListeners:l,listen:u,destroy:p}}function Sm(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Kc():null}}function Tk(t){const{history:e,location:n}=window,r={value:lE(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(l,u,f){const p=t.indexOf("#"),m=p>-1?(n.host&&document.querySelector("base")?t:t.slice(p))+l:Ek()+t+l;try{e[f?"replaceState":"pushState"](u,"",m),s.value=u}catch(_){console.error(_),n[f?"replace":"assign"](m)}}function o(l,u){const f=Ve({},e.state,Sm(s.value.back,l,s.value.forward,!0),u,{position:s.value.position});i(l,f,!0),r.value=l}function c(l,u){const f=Ve({},s.value,e.state,{forward:l,scroll:Kc()});i(f.current,f,!0);const p=Ve({},Sm(r.value,l,null),{position:f.position+1},u);i(l,p,!1),r.value=l}return{location:r,state:s,push:c,replace:o}}function Ik(t){t=dk(t);const e=Tk(t),n=wk(t,e.state,e.location,e.replace);function r(i,o=!0){o||n.pauseListeners(),history.go(i)}const s=Ve({location:"",base:t,go:r,createHref:mk.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Ak(t){return t=location.host?t||location.pathname+location.search:"",t.includes("#")||(t+="#"),Ik(t)}function bk(t){return typeof t=="string"||t&&typeof t=="object"}function uE(t){return typeof t=="string"||typeof t=="symbol"}const hE=Symbol("");var Cm;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Cm||(Cm={}));function Zs(t,e){return Ve(new Error,{type:t,[hE]:!0},e)}function Bn(t,e){return t instanceof Error&&hE in t&&(e==null||!!(t.type&e))}const Pm="[^/]+?",Rk={sensitive:!1,strict:!1,start:!0,end:!0},Sk=/[.+*?^${}()[\]/\\]/g;function Ck(t,e){const n=Ve({},Rk,e),r=[];let s=n.start?"^":"";const i=[];for(const u of t){const f=u.length?[]:[90];n.strict&&!u.length&&(s+="/");for(let p=0;p<u.length;p++){const m=u[p];let _=40+(n.sensitive?.25:0);if(m.type===0)p||(s+="/"),s+=m.value.replace(Sk,"\\$&"),_+=40;else if(m.type===1){const{value:S,repeatable:N,optional:V,regexp:j}=m;i.push({name:S,repeatable:N,optional:V});const q=j||Pm;if(q!==Pm){_+=10;try{new RegExp(`(${q})`)}catch(D){throw new Error(`Invalid custom RegExp for param "${S}" (${q}): `+D.message)}}let x=N?`((?:${q})(?:/(?:${q}))*)`:`(${q})`;p||(x=V&&u.length<2?`(?:/${x})`:"/"+x),V&&(x+="?"),s+=x,_+=20,V&&(_+=-8),N&&(_+=-20),q===".*"&&(_+=-50)}f.push(_)}r.push(f)}if(n.strict&&n.end){const u=r.length-1;r[u][r[u].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&!s.endsWith("/")&&(s+="(?:/|$)");const o=new RegExp(s,n.sensitive?"":"i");function c(u){const f=u.match(o),p={};if(!f)return null;for(let m=1;m<f.length;m++){const _=f[m]||"",S=i[m-1];p[S.name]=_&&S.repeatable?_.split("/"):_}return p}function l(u){let f="",p=!1;for(const m of t){(!p||!f.endsWith("/"))&&(f+="/"),p=!1;for(const _ of m)if(_.type===0)f+=_.value;else if(_.type===1){const{value:S,repeatable:N,optional:V}=_,j=S in u?u[S]:"";if(vn(j)&&!N)throw new Error(`Provided param "${S}" is an array but it is not repeatable (* or + modifiers)`);const q=vn(j)?j.join("/"):j;if(!q)if(V)m.length<2&&(f.endsWith("/")?f=f.slice(0,-1):p=!0);else throw new Error(`Missing required param "${S}"`);f+=q}}return f||"/"}return{re:o,score:r,keys:i,parse:c,stringify:l}}function Pk(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===80?-1:1:t.length>e.length?e.length===1&&e[0]===80?1:-1:0}function fE(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=Pk(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(km(r))return 1;if(km(s))return-1}return s.length-r.length}function km(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const kk={type:0,value:""},Nk=/[a-zA-Z0-9_]/;function Dk(t){if(!t)return[[]];if(t==="/")return[[kk]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(_){throw new Error(`ERR (${n})/"${u}": ${_}`)}let n=0,r=n;const s=[];let i;function o(){i&&s.push(i),i=[]}let c=0,l,u="",f="";function p(){u&&(n===0?i.push({type:0,value:u}):n===1||n===2||n===3?(i.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:u,regexp:f,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),u="")}function m(){u+=l}for(;c<t.length;){if(l=t[c++],l==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:l==="/"?(u&&p(),o()):l===":"?(p(),n=1):m();break;case 4:m(),n=r;break;case 1:l==="("?n=2:Nk.test(l)?m():(p(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--);break;case 2:l===")"?f[f.length-1]=="\\"?f=f.slice(0,-1)+l:n=3:f+=l;break;case 3:p(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--,f="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${u}"`),p(),o(),s}function Vk(t,e,n){const r=Ck(Dk(t.path),n),s=Ve(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function Ok(t,e){const n=[],r=new Map;e=Om({strict:!1,end:!0,sensitive:!1},e);function s(p){return r.get(p)}function i(p,m,_){const S=!_,N=Dm(p);N.aliasOf=_&&_.record;const V=Om(e,p),j=[N];if("alias"in p){const D=typeof p.alias=="string"?[p.alias]:p.alias;for(const z of D)j.push(Dm(Ve({},N,{components:_?_.record.components:N.components,path:z,aliasOf:_?_.record:N})))}let q,x;for(const D of j){const{path:z}=D;if(m&&z[0]!=="/"){const te=m.record.path,b=te[te.length-1]==="/"?"":"/";D.path=m.record.path+(z&&b+z)}if(q=Vk(D,m,V),_?_.alias.push(q):(x=x||q,x!==q&&x.alias.push(q),S&&p.name&&!Vm(q)&&o(p.name)),dE(q)&&l(q),N.children){const te=N.children;for(let b=0;b<te.length;b++)i(te[b],q,_&&_.children[b])}_=_||q}return x?()=>{o(x)}:Xi}function o(p){if(uE(p)){const m=r.get(p);m&&(r.delete(p),n.splice(n.indexOf(m),1),m.children.forEach(o),m.alias.forEach(o))}else{const m=n.indexOf(p);m>-1&&(n.splice(m,1),p.record.name&&r.delete(p.record.name),p.children.forEach(o),p.alias.forEach(o))}}function c(){return n}function l(p){const m=Lk(p,n);n.splice(m,0,p),p.record.name&&!Vm(p)&&r.set(p.record.name,p)}function u(p,m){let _,S={},N,V;if("name"in p&&p.name){if(_=r.get(p.name),!_)throw Zs(1,{location:p});V=_.record.name,S=Ve(Nm(m.params,_.keys.filter(x=>!x.optional).concat(_.parent?_.parent.keys.filter(x=>x.optional):[]).map(x=>x.name)),p.params&&Nm(p.params,_.keys.map(x=>x.name))),N=_.stringify(S)}else if(p.path!=null)N=p.path,_=n.find(x=>x.re.test(N)),_&&(S=_.parse(N),V=_.record.name);else{if(_=m.name?r.get(m.name):n.find(x=>x.re.test(m.path)),!_)throw Zs(1,{location:p,currentLocation:m});V=_.record.name,S=Ve({},m.params,p.params),N=_.stringify(S)}const j=[];let q=_;for(;q;)j.unshift(q.record),q=q.parent;return{name:V,path:N,params:S,matched:j,meta:Mk(j)}}t.forEach(p=>i(p));function f(){n.length=0,r.clear()}return{addRoute:i,resolve:u,removeRoute:o,clearRoutes:f,getRoutes:c,getRecordMatcher:s}}function Nm(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function Dm(t){const e={path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:t.aliasOf,beforeEnter:t.beforeEnter,props:xk(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function xk(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function Vm(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Mk(t){return t.reduce((e,n)=>Ve(e,n.meta),{})}function Om(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function Lk(t,e){let n=0,r=e.length;for(;n!==r;){const i=n+r>>1;fE(t,e[i])<0?r=i:n=i+1}const s=Fk(t);return s&&(r=e.lastIndexOf(s,r-1)),r}function Fk(t){let e=t;for(;e=e.parent;)if(dE(e)&&fE(t,e)===0)return e}function dE({record:t}){return!!(t.name||t.components&&Object.keys(t.components).length||t.redirect)}function Uk(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(sE," "),o=i.indexOf("="),c=vo(o<0?i:i.slice(0,o)),l=o<0?null:vo(i.slice(o+1));if(c in e){let u=e[c];vn(u)||(u=e[c]=[u]),u.push(l)}else e[c]=l}return e}function xm(t){let e="";for(let n in t){const r=t[n];if(n=sk(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(vn(r)?r.map(i=>i&&Du(i)):[r&&Du(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function $k(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=vn(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const Bk=Symbol(""),Mm=Symbol(""),Gc=Symbol(""),sf=Symbol(""),Ou=Symbol("");function Ri(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function gr(t,e,n,r,s,i=o=>o()){const o=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((c,l)=>{const u=m=>{m===!1?l(Zs(4,{from:n,to:e})):m instanceof Error?l(m):bk(m)?l(Zs(2,{from:e,to:m})):(o&&r.enterCallbacks[s]===o&&typeof m=="function"&&o.push(m),c())},f=i(()=>t.call(r&&r.instances[s],e,n,u));let p=Promise.resolve(f);t.length<3&&(p=p.then(u)),p.catch(m=>l(m))})}function Bl(t,e,n,r,s=i=>i()){const i=[];for(const o of t)for(const c in o.components){let l=o.components[c];if(!(e!=="beforeRouteEnter"&&!o.instances[c]))if(nE(l)){const f=(l.__vccOpts||l)[e];f&&i.push(gr(f,n,r,o,c,s))}else{let u=l();i.push(()=>u.then(f=>{if(!f)throw new Error(`Couldn't resolve component "${c}" at "${o.path}"`);const p=K1(f)?f.default:f;o.mods[c]=f,o.components[c]=p;const _=(p.__vccOpts||p)[e];return _&&gr(_,n,r,o,c,s)()}))}}return i}function Lm(t){const e=pn(Gc),n=pn(sf),r=Ft(()=>{const l=Kn(t.to);return e.resolve(l)}),s=Ft(()=>{const{matched:l}=r.value,{length:u}=l,f=l[u-1],p=n.matched;if(!f||!p.length)return-1;const m=p.findIndex(Xs.bind(null,f));if(m>-1)return m;const _=Fm(l[u-2]);return u>1&&Fm(f)===_&&p[p.length-1].path!==_?p.findIndex(Xs.bind(null,l[u-2])):m}),i=Ft(()=>s.value>-1&&Wk(n.params,r.value.params)),o=Ft(()=>s.value>-1&&s.value===n.matched.length-1&&cE(n.params,r.value.params));function c(l={}){if(zk(l)){const u=e[Kn(t.replace)?"replace":"push"](Kn(t.to)).catch(Xi);return t.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:r,href:Ft(()=>r.value.href),isActive:i,isExactActive:o,navigate:c}}function qk(t){return t.length===1?t[0]:t}const jk=Sg({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Lm,setup(t,{slots:e}){const n=hc(Lm(t)),{options:r}=pn(Gc),s=Ft(()=>({[Um(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[Um(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&qk(e.default(n));return t.custom?i:Ju("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),Hk=jk;function zk(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function Wk(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!vn(s)||s.length!==r.length||r.some((i,o)=>i!==s[o]))return!1}return!0}function Fm(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const Um=(t,e,n)=>t??e??n,Kk=Sg({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=pn(Ou),s=Ft(()=>t.route||r.value),i=pn(Mm,0),o=Ft(()=>{let u=Kn(i);const{matched:f}=s.value;let p;for(;(p=f[u])&&!p.components;)u++;return u}),c=Ft(()=>s.value.matched[o.value]);da(Mm,Ft(()=>o.value+1)),da(Bk,c),da(Ou,s);const l=we();return qi(()=>[l.value,c.value,t.name],([u,f,p],[m,_,S])=>{f&&(f.instances[p]=u,_&&_!==f&&u&&u===m&&(f.leaveGuards.size||(f.leaveGuards=_.leaveGuards),f.updateGuards.size||(f.updateGuards=_.updateGuards))),u&&f&&(!_||!Xs(f,_)||!m)&&(f.enterCallbacks[p]||[]).forEach(N=>N(u))},{flush:"post"}),()=>{const u=s.value,f=t.name,p=c.value,m=p&&p.components[f];if(!m)return $m(n.default,{Component:m,route:u});const _=p.props[f],S=_?_===!0?u.params:typeof _=="function"?_(u):_:null,V=Ju(m,Ve({},S,e,{onVnodeUnmounted:j=>{j.component.isUnmounted&&(p.instances[f]=null)},ref:l}));return $m(n.default,{Component:V,route:u})||V}}});function $m(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Gk=Kk;function Qk(t){const e=Ok(t.routes,t),n=t.parseQuery||Uk,r=t.stringifyQuery||xm,s=t.history,i=Ri(),o=Ri(),c=Ri(),l=Ew(fr);let u=fr;ks&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const f=Ul.bind(null,L=>""+L),p=Ul.bind(null,ok),m=Ul.bind(null,vo);function _(L,Z){let X,ne;return uE(L)?(X=e.getRecordMatcher(L),ne=Z):ne=L,e.addRoute(ne,X)}function S(L){const Z=e.getRecordMatcher(L);Z&&e.removeRoute(Z)}function N(){return e.getRoutes().map(L=>L.record)}function V(L){return!!e.getRecordMatcher(L)}function j(L,Z){if(Z=Ve({},Z||l.value),typeof L=="string"){const C=$l(n,L,Z.path),F=e.resolve({path:C.path},Z),B=s.createHref(C.fullPath);return Ve(C,F,{params:m(F.params),hash:vo(C.hash),redirectedFrom:void 0,href:B})}let X;if(L.path!=null)X=Ve({},L,{path:$l(n,L.path,Z.path).path});else{const C=Ve({},L.params);for(const F in C)C[F]==null&&delete C[F];X=Ve({},L,{params:p(C)}),Z.params=p(Z.params)}const ne=e.resolve(X,Z),ke=L.hash||"";ne.params=f(m(ne.params));const w=lk(r,Ve({},L,{hash:rk(ke),path:ne.path})),T=s.createHref(w);return Ve({fullPath:w,hash:ke,query:r===xm?$k(L.query):L.query||{}},ne,{redirectedFrom:void 0,href:T})}function q(L){return typeof L=="string"?$l(n,L,l.value.path):Ve({},L)}function x(L,Z){if(u!==L)return Zs(8,{from:Z,to:L})}function D(L){return b(L)}function z(L){return D(Ve(q(L),{replace:!0}))}function te(L){const Z=L.matched[L.matched.length-1];if(Z&&Z.redirect){const{redirect:X}=Z;let ne=typeof X=="function"?X(L):X;return typeof ne=="string"&&(ne=ne.includes("?")||ne.includes("#")?ne=q(ne):{path:ne},ne.params={}),Ve({query:L.query,hash:L.hash,params:ne.path!=null?{}:L.params},ne)}}function b(L,Z){const X=u=j(L),ne=l.value,ke=L.state,w=L.force,T=L.replace===!0,C=te(X);if(C)return b(Ve(q(C),{state:typeof C=="object"?Ve({},ke,C.state):ke,force:w,replace:T}),Z||X);const F=X;F.redirectedFrom=Z;let B;return!w&&uk(r,ne,X)&&(B=Zs(16,{to:F,from:ne}),Ue(ne,ne,!0,!1)),(B?Promise.resolve(B):I(F,ne)).catch(U=>Bn(U)?Bn(U,2)?U:Fe(U):fe(U,F,ne)).then(U=>{if(U){if(Bn(U,2))return b(Ve({replace:T},q(U.to),{state:typeof U.to=="object"?Ve({},ke,U.to.state):ke,force:w}),Z||F)}else U=A(F,ne,!0,T,ke);return R(F,ne,U),U})}function E(L,Z){const X=x(L,Z);return X?Promise.reject(X):Promise.resolve()}function y(L){const Z=zt.values().next().value;return Z&&typeof Z.runWithContext=="function"?Z.runWithContext(L):L()}function I(L,Z){let X;const[ne,ke,w]=Yk(L,Z);X=Bl(ne.reverse(),"beforeRouteLeave",L,Z);for(const C of ne)C.leaveGuards.forEach(F=>{X.push(gr(F,L,Z))});const T=E.bind(null,L,Z);return X.push(T),vt(X).then(()=>{X=[];for(const C of i.list())X.push(gr(C,L,Z));return X.push(T),vt(X)}).then(()=>{X=Bl(ke,"beforeRouteUpdate",L,Z);for(const C of ke)C.updateGuards.forEach(F=>{X.push(gr(F,L,Z))});return X.push(T),vt(X)}).then(()=>{X=[];for(const C of w)if(C.beforeEnter)if(vn(C.beforeEnter))for(const F of C.beforeEnter)X.push(gr(F,L,Z));else X.push(gr(C.beforeEnter,L,Z));return X.push(T),vt(X)}).then(()=>(L.matched.forEach(C=>C.enterCallbacks={}),X=Bl(w,"beforeRouteEnter",L,Z,y),X.push(T),vt(X))).then(()=>{X=[];for(const C of o.list())X.push(gr(C,L,Z));return X.push(T),vt(X)}).catch(C=>Bn(C,8)?C:Promise.reject(C))}function R(L,Z,X){c.list().forEach(ne=>y(()=>ne(L,Z,X)))}function A(L,Z,X,ne,ke){const w=x(L,Z);if(w)return w;const T=Z===fr,C=ks?history.state:{};X&&(ne||T?s.replace(L.fullPath,Ve({scroll:T&&C&&C.scroll},ke)):s.push(L.fullPath,ke)),l.value=L,Ue(L,Z,X,T),Fe()}let v;function se(){v||(v=s.listen((L,Z,X)=>{if(!xt.listening)return;const ne=j(L),ke=te(ne);if(ke){b(Ve(ke,{replace:!0,force:!0}),ne).catch(Xi);return}u=ne;const w=l.value;ks&&yk(Rm(w.fullPath,X.delta),Kc()),I(ne,w).catch(T=>Bn(T,12)?T:Bn(T,2)?(b(Ve(q(T.to),{force:!0}),ne).then(C=>{Bn(C,20)&&!X.delta&&X.type===Eo.pop&&s.go(-1,!1)}).catch(Xi),Promise.reject()):(X.delta&&s.go(-X.delta,!1),fe(T,ne,w))).then(T=>{T=T||A(ne,w,!1),T&&(X.delta&&!Bn(T,8)?s.go(-X.delta,!1):X.type===Eo.pop&&Bn(T,20)&&s.go(-1,!1)),R(ne,w,T)}).catch(Xi)}))}let ve=Ri(),Te=Ri(),Ee;function fe(L,Z,X){Fe(L);const ne=Te.list();return ne.length?ne.forEach(ke=>ke(L,Z,X)):console.error(L),Promise.reject(L)}function Ge(){return Ee&&l.value!==fr?Promise.resolve():new Promise((L,Z)=>{ve.add([L,Z])})}function Fe(L){return Ee||(Ee=!L,se(),ve.list().forEach(([Z,X])=>L?X(L):Z()),ve.reset()),L}function Ue(L,Z,X,ne){const{scrollBehavior:ke}=t;if(!ks||!ke)return Promise.resolve();const w=!X&&vk(Rm(L.fullPath,0))||(ne||!X)&&history.state&&history.state.scroll||null;return dc().then(()=>ke(L,Z,w)).then(T=>T&&_k(T)).catch(T=>fe(T,L,Z))}const Me=L=>s.go(L);let Le;const zt=new Set,xt={currentRoute:l,listening:!0,addRoute:_,removeRoute:S,clearRoutes:e.clearRoutes,hasRoute:V,getRoutes:N,resolve:j,options:t,push:D,replace:z,go:Me,back:()=>Me(-1),forward:()=>Me(1),beforeEach:i.add,beforeResolve:o.add,afterEach:c.add,onError:Te.add,isReady:Ge,install(L){const Z=this;L.component("RouterLink",Hk),L.component("RouterView",Gk),L.config.globalProperties.$router=Z,Object.defineProperty(L.config.globalProperties,"$route",{enumerable:!0,get:()=>Kn(l)}),ks&&!Le&&l.value===fr&&(Le=!0,D(s.location).catch(ke=>{}));const X={};for(const ke in fr)Object.defineProperty(X,ke,{get:()=>l.value[ke],enumerable:!0});L.provide(Gc,Z),L.provide(sf,cg(X)),L.provide(Ou,l);const ne=L.unmount;zt.add(L),L.unmount=function(){zt.delete(L),zt.size<1&&(u=fr,v&&v(),v=null,l.value=fr,Le=!1,Ee=!1),ne()}}};function vt(L){return L.reduce((Z,X)=>Z.then(()=>y(X)),Promise.resolve())}return xt}function Yk(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const c=e.matched[o];c&&(t.matched.find(u=>Xs(u,c))?r.push(c):n.push(c));const l=t.matched[o];l&&(e.matched.find(u=>Xs(u,l))||s.push(l))}return[n,r,s]}function Qc(){return pn(Gc)}function TD(t){return pn(sf)}const ql=we(!1),$r=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},Jk={class:"navbar"},Xk={class:"navbar-container"},Zk={key:0,class:"dropdown-content"},eN={key:0,class:"highlight"},tN=["disabled"],nN={key:0,class:"reward-dropdown"},rN={__name:"Navbar",setup(t){const{user:e}=W1(),n=Qc(),r=we(!1),s=we(null),i=we(!1),o=we(!1),c=we(null),l=we(null);we(!1);const u=we(null),f=we(null),p=()=>{i.value=!i.value},m=()=>{i.value=!1};un(async()=>{if(e.value){const v=await Qn(He(Ae,"users",e.value.uid));v.exists()&&(l.value=v.data().role)}});const _=()=>{o.value=!o.value},S=async()=>{await f0(at),m(),n.push("/")},N=we([]),V=we(null),j=we(null);un(()=>{const v=bn(Ae,"users");_o(v,async se=>{const ve=se.docs.map(Fe=>{const Ue=Fe.data(),Me=Ue.correct*10-Ue.timeSpent/60,Le=Math.round(Me),zt=Math.floor((Ue.timeSpent||0)/60),xt=(Ue.timeSpent||0)%60,vt=`${zt}:${xt.toString().padStart(2,"0")}`;return{id:Fe.id,name:Ue.name||"Unknown",score:Le,correct:Ue.correct||0,timeSpent:vt}});ve.sort((Fe,Ue)=>Ue.score-Fe.score||Ue.correct-Fe.correct||Fe.timeSpent.localeCompare(Ue.timeSpent));const Te=ve.slice(0,10);N.value=Te;const Ee=new Set(Te.map(Fe=>Fe.id)),fe=Yp(Ae);se.docs.forEach(Fe=>{const Ue=Fe.id,Me=Fe.data(),Le=He(Ae,"users",Ue);if(Ee.has(Ue)){const zt=Te.findIndex(xt=>xt.id===Ue)+1;Me.rank!==zt&&fe.update(Le,{rank:zt})}else Me.rank!==void 0&&fe.update(Le,{rank:aC()})}),await fe.commit();const Ge=ve.find(Fe=>Fe.id===e.value?.uid);Ge?(j.value=ve.findIndex(Fe=>Fe.id===Ge.id)+1,V.value={...Ge,score:Math.round(Ge.score),timeSpent:Ge.timeSpent}):(j.value=null,V.value=null)})});const q=v=>{c.value&&!c.value.contains(v.target)&&(o.value=!1)};un(()=>{document.addEventListener("click",q)}),Ms(()=>{document.removeEventListener("click",q)});const x=we(!1),D=we(null),z=async()=>{const v=await Qn(He(Ae,"settings","resetMeta"));if(v.exists()){D.value=v.data().lastReset;const se=Date.now(),ve=D.value instanceof We?D.value.toMillis():D.value,Te=10080*60*1e3;x.value=se-ve<Te}};un(()=>{z()});const te=async()=>{if(!x.value)try{const v=bn(Ae,"users"),se=await Qi(v),ve=Yp(Ae);se.forEach(fe=>{const Ge=He(Ae,"users",fe.id);ve.update(Ge,{balance:0})});const Te=es(v,$s("rank","==",1));(await Qi(Te)).forEach(fe=>{const Ge=He(Ae,"users",fe.id);ve.update(Ge,{balance:20})}),se.forEach(fe=>{const Ge=He(Ae,"users",fe.id);ve.update(Ge,{correct:0,question:0,timeSpent:0,questionNo:[]})}),await ve.commit(),await as(He(Ae,"settings","resetMeta"),{lastReset:Ns()}),x.value=!0,alert("Reset complete! All balances cleared, winner credited, and stats reset.")}catch(v){console.error("Error during reset:",v),alert("Error occurred during reset. Check console.")}},b=Ft(()=>x.value?"reset-btn-blue":"reset-btn-red");qi(e,async v=>{if(v){const se=await Qn(He(Ae,"users",v.uid));se.exists()&&(l.value=se.data().role)}else l.value=null},{immediate:!0});let E=null;const y=v=>{const se=He(Ae,"users",v);E=_o(se,ve=>{ve.exists()?u.value=ve.data().balance||0:u.value=0})};un(()=>{ui(at,v=>{v&&(f.value=v.uid,y(v.uid))})}),Ms(()=>{E&&E()});const I=()=>{r.value=!r.value},R=()=>{r.value=!1},A=v=>{s.value&&!s.value.contains(v.target)&&R()};return un(()=>{document.addEventListener("click",A)}),Ms(()=>{document.removeEventListener("click",A)}),(v,se)=>{const ve=cs("router-link");return pe(),Ie("nav",Jk,[k("div",Xk,[Ke(ve,{to:"/",class:"logo"},{default:en(()=>se[0]||(se[0]=[_e("QuizGames",-1)])),_:1,__:[0]}),k("button",{class:"menu-toggle",onClick:p},"☰"),k("div",{class:Tr(["nav-links",{open:i.value}])},[Ke(ve,{to:"/",onClick:m,class:"nav-link"},{default:en(()=>se[1]||(se[1]=[_e("Home",-1)])),_:1,__:[1]}),k("div",{class:"dropdown nav-item",ref_key:"dropdownRef",ref:c},[k("button",{onClick:_,class:"nav-link dropdown-btn"}," Leaderboard ⏷ "),o.value?(pe(),Ie("div",Zk,[k("table",null,[se[2]||(se[2]=k("thead",null,[k("tr",null,[k("th",null,"Rank"),k("th",null,"Name"),k("th",null,"Score"),k("th",null,"Correct"),k("th",null,"Time")])],-1)),k("tbody",null,[(pe(!0),Ie(ot,null,gc(N.value,(Te,Ee)=>(pe(),Ie("tr",{key:Te.id,class:Tr({highlight:Te.id===Kn(e)?.uid})},[k("td",null,Ze(Ee+1),1),k("td",null,Ze(Te.name),1),k("td",null,Ze(Te.score),1),k("td",null,Ze(Te.correct),1),k("td",null,Ze(Te.timeSpent),1)],2))),128)),j.value>10?(pe(),Ie("tr",eN,[k("td",null,Ze(j.value),1),k("td",null,Ze(V.value?.name),1),k("td",null,Ze(V.value?.score),1),k("td",null,Ze(V.value?.correct),1),k("td",null,Ze(V.value?.timeSpent),1)])):Bt("",!0)])])])):Bt("",!0)],512),Kn(e)?(pe(),Ie(ot,{key:1},[l.value==="admin"?(pe(),Ie("button",{key:0,disabled:x.value,class:Tr(b.value),onClick:te}," Reset ",10,tN)):Bt("",!0),k("div",{class:"reward-container",ref_key:"rewardRef",ref:s},[k("button",{class:"reward-btn",onClick:I}," Reward ⏷ "),r.value?(pe(),Ie("div",nN,[k("p",null,[se[5]||(se[5]=k("strong",null,"Wins:",-1)),_e(" "+Ze(u.value??"Loading...")+" coins",1)])])):Bt("",!0)],512),Ke(ve,{to:"/topics",onClick:m,class:"nav-link"},{default:en(()=>se[6]||(se[6]=[_e("Topics",-1)])),_:1,__:[6]}),k("button",{class:"nav-link logout-btn",onClick:S},"Logout")],64)):(pe(),Ie(ot,{key:0},[Ke(ve,{to:"/login",onClick:m,class:"nav-link"},{default:en(()=>se[3]||(se[3]=[_e("Login",-1)])),_:1,__:[3]}),Ke(ve,{to:"/signup",onClick:m,class:"nav-link"},{default:en(()=>se[4]||(se[4]=[_e("Sign Up",-1)])),_:1,__:[4]})],64))],2)])])}}},sN=$r(rN,[["__scopeId","data-v-a7fed612"]]),iN={class:"min-h-screen bg-base text-dark font-sans flex flex-col"},oN={class:"container mx-auto p-4 flex-grow"},aN={class:"footer-bar"},cN={__name:"App",setup(t){const e=Qc(),n=typeof FBInstant<"u";return ui(at,async r=>{if(r)e.push("/");else if(n){const s=new nn;await Pv(at,s)}else console.log("Web user, no auto-login")}),kv(at).then(async r=>{if(r?.user){const s=r.user;await as(He(Ae,"users",s.uid),{uid:s.uid,name:s.displayName||"",email:s.email,photoURL:s.photoURL||"",lastLogin:new Date},{merge:!0}),e.push("/")}}).catch(r=>console.error("FB Redirect Login Error:",r)),(r,s)=>{const i=cs("router-view"),o=cs("router-link");return pe(),Ie("div",iN,[Ke(sN),k("div",oN,[Ke(i)]),k("footer",aN,[k("p",null,"© "+Ze(new Date().getFullYear())+" Howell. All rights reserved.",1),Ke(o,{to:"/policies",class:"footer-link"},{default:en(()=>s[0]||(s[0]=[_e("Policies",-1)])),_:1,__:[0]})])])}}},lN="modulepreload",uN=function(t,e){return new URL(t,e).href},Bm={},jl=function(e,n,r){let s=Promise.resolve();if(n&&n.length>0){let u=function(f){return Promise.all(f.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};const o=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),l=c?.nonce||c?.getAttribute("nonce");s=u(n.map(f=>{if(f=uN(f,r),f in Bm)return;Bm[f]=!0;const p=f.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(!!r)for(let N=o.length-1;N>=0;N--){const V=o[N];if(V.href===f&&(!p||V.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${f}"]${m}`))return;const S=document.createElement("link");if(S.rel=p?"stylesheet":lN,p||(S.as="script"),S.crossOrigin="",S.href=f,l&&S.setAttribute("nonce",l),document.head.appendChild(S),p)return new Promise((N,V)=>{S.addEventListener("load",N),S.addEventListener("error",()=>V(new Error(`Unable to preload CSS for ${f}`)))})}))}function i(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return s.then(o=>{for(const c of o||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},pE=""+new URL("bg-BIo0N03c.mp4",import.meta.url).href,hN={class:"modal-content"},fN={__name:"RulesModal",props:{open:Boolean},setup(t){return(e,n)=>(pe(),ss(Eg,{to:"body"},[t.open?(pe(),Ie("div",{key:0,class:"modal-overlay",onClick:n[1]||(n[1]=Ec(r=>e.$emit("close"),["self"]))},[k("div",hN,[n[2]||(n[2]=k("h2",null,"Howell – Rules, Policies & Information",-1)),n[3]||(n[3]=k("h3",null,"How to Play",-1)),n[4]||(n[4]=k("p",null,[_e(" To play Howell, users must "),k("strong",null,"sign up and log in"),_e(". Once logged in, click on "),k("strong",null,"“Topics”"),_e(" in the navigation bar. You may choose from different quiz topics, including weekly competitions. ")],-1)),n[5]||(n[5]=k("p",null,[_e(" At the end of every quiz, your "),k("strong",null,"score and performance"),_e(" are displayed. ")],-1)),n[6]||(n[6]=k("h3",null,"Rules of Competition",-1)),n[7]||(n[7]=k("p",null,[_e(" Participation in Howell competitions is free. No entry fee is required. Winners are determined based on skill — quiz performance is calculated using: "),k("strong",null,"time spent, correct answers, and number of questions completed"),_e(". ")],-1)),n[8]||(n[8]=k("ul",null,[k("li",null,"Each weekly competition features around 50 questions on a trending athlete."),k("li",null,"The leaderboard ranks players based on accuracy and speed."),k("li",null,[_e("The top leaderboard player of the week wins "),k("strong",null,"20 coins"),_e(".")]),k("li",null,[_e("Coins are withdrawable after accumulating "),k("strong",null,"100+ coins"),_e(".")]),k("li",null,"Rewards must be claimed manually via in-game chat. Howell admins will verify standings before awarding prizes.")],-1)),n[9]||(n[9]=k("h3",null,"Reward Structure",-1)),n[10]||(n[10]=k("ul",null,[k("li",null,[_e("Weekly competition winner: "),k("strong",null,"20 coins"),_e(".")]),k("li",null,[_e("Regular quizzes: earn "),k("strong",null,"2–5 coins"),_e(" per quiz, depending on frequency.")]),k("li",null,"Coins have a withdrawable value determined by app growth, set by the admin."),k("li",null,"Withdrawal methods: chat-arranged (bank transfer, PayPal, or other agreed method).")],-1)),n[11]||(n[11]=k("h3",null,"Privacy Policy",-1)),n[12]||(n[12]=k("p",null,[_e(" Howell respects your privacy. We only collect "),k("strong",null,"basic user data"),_e(" such as your name, email, or phone number. This data is used solely for: ")],-1)),n[13]||(n[13]=k("ul",null,[k("li",null,"Tracking quiz progress and scores."),k("li",null,"Managing leaderboards and competitions."),k("li",null,"Enabling communication about rewards through in-game chat.")],-1)),n[14]||(n[14]=k("p",null," We do not sell, rent, or share your personal data with third-party advertisers or external services. ",-1)),n[15]||(n[15]=k("h3",null,"User Data Handling",-1)),n[16]||(n[16]=k("p",null,[_e(" Your data is stored securely using "),k("strong",null,"Firebase Authentication and Firestore"),_e(". Only Howell administrators have access to reward verification data. Users may request data removal or account deletion at any time by contacting the developer. ")],-1)),n[17]||(n[17]=k("h3",null,"Disclaimer",-1)),n[18]||(n[18]=k("p",null,[_e(" Howell is a "),k("strong",null,"skill-based educational and entertainment quiz game"),_e(". It does not involve gambling, betting, or random draws of any kind. Rewards are provided only to verified winners and are not guaranteed for every participant. ")],-1)),n[19]||(n[19]=k("p",null," Howell reserves the right to adjust competition details, rules, and rewards at its discretion. ",-1)),n[20]||(n[20]=k("h3",null,"Contact Information",-1)),n[21]||(n[21]=k("p",null,[_e(" For support, questions, or data requests, please contact: "),k("br"),k("strong",null,"Developer:"),_e(" Ebuka Jullian "),k("br"),k("strong",null,"Email:"),_e(),k("a",{href:"mailto:ebukaolisaemeka@yahoo.com"},"ebukaolisaemeka@yahoo.com")],-1)),k("button",{class:"close-btn",onClick:n[0]||(n[0]=r=>e.$emit("close"))},"Close")])])):Bt("",!0)]))}},dN=$r(fN,[["__scopeId","data-v-ab2411c0"]]),pN={class:"admin-chat-list"},mN={key:0},gN=["onClick"],_N={class:"user-name"},yN={key:0,class:"unread-badge"},vN={key:1},EN={__name:"AdminChatList",emits:["chat-selected"],setup(t,{emit:e}){const n=e,r=we([]);un(()=>{const i=at.currentUser.uid,o=es(bn(Ae,"chats"),$s("participants","array-contains",i));_o(o,async c=>{const l=[];for(const u of c.docs){const f=u.data(),p=f.participants.find(m=>m!==i);if(p){const m=await Qn(He(Ae,"users",p)),_=m.exists()?m.data():{};l.push({id:p,chatId:u.id,..._,unreadCount:f.unread?.[i]||0})}}r.value=l})});async function s(i,o){const c=at.currentUser.uid;o&&(await Oi(He(Ae,"chats",o),{[`unread.${c}`]:0}),n("chat-selected",o))}return(i,o)=>(pe(),Ie("div",pN,[o[0]||(o[0]=k("h2",null,"All Chats",-1)),r.value.length?(pe(),Ie("ul",mN,[(pe(!0),Ie(ot,null,gc(r.value,c=>(pe(),Ie("li",{key:c.id,onClick:l=>s(c.id,c.chatId)},[k("span",_N,Ze(c.name||"Unknown User"),1),c.unreadCount>0?(pe(),Ie("span",yN,Ze(c.unreadCount),1)):Bt("",!0)],8,gN))),128))])):(pe(),Ie("p",vN,"No chats found"))]))}},wN=$r(EN,[["__scopeId","data-v-26cbb575"]]),TN={class:"modal-content"},IN={class:"modal-header"},AN={key:0},bN={key:1},RN={key:0,class:"withdraw-form"},SN={class:"withdraw-actions"},CN=["disabled"],PN={class:"input-area"},kN={__name:"ChatModal",props:{isAdmin:Boolean},setup(t){const e=t,n=we(""),r=we([]),s=we(""),i=we(null),o=we(null),c=we([]),l=we(null),u=we(!1),f=we({country:"",currency:"",bank:"",accountNumber:"",amount:0});function p(){dc(()=>{l.value&&(l.value.scrollTop=l.value.scrollHeight)})}const m=Ft(()=>{const x=f.value;return x.country.trim()&&x.currency.trim()&&x.bank.trim()&&x.accountNumber.trim()&&Number(x.amount)>0});async function _(x){s.value=x,o.value=x;const D=await Qn(He(Ae,"chats",x));D.exists()&&(c.value=D.data().participants||[]);const z=at.currentUser?.uid;z&&await Oi(He(Ae,"chats",x),{[`unread.${z}`]:0}).catch(()=>{}),N()}async function S(){if(!i.value||e.isAdmin)return;const x=i.value.uid,D=es(bn(Ae,"users"),$s("role","==","admin")),z=await Qi(D);if(z.empty)return;const te=z.docs[0].id,b=bn(Ae,"chats"),E=es(b,$s("participants","array-contains",x)),y=await Qi(E);if(y.empty){const I=await Dl(b,{participants:[x,te],updatedAt:Ns(),unread:{[te]:0,[x]:0}});s.value=I.id,c.value=[x,te]}else{const I=y.docs[0];s.value=I.id,c.value=I.data().participants||[x,te],c.value.includes(te)||(c.value.push(te),await Oi(He(Ae,"chats",s.value),{participants:c.value,[`unread.${te}`]:0}))}N()}function N(){if(!s.value)return;const x=es(bn(Ae,"chats",s.value,"messages"),rC("timestamp","asc"));_o(x,D=>{r.value=D.docs.map(z=>({id:z.id,...z.data()})),p()})}async function V(){if(!n.value.trim()||!s.value||!i.value)return;const x=i.value.uid;if(!c.value?.length){const b=await Qn(He(Ae,"chats",s.value));b.exists()&&(c.value=b.data().participants||[])}if(c.value.length===1&&!e.isAdmin){const b=es(bn(Ae,"users"),$s("role","==","admin")),E=await Qi(b);if(!E.empty){const y=E.docs[0].id;c.value.push(y),await Oi(He(Ae,"chats",s.value),{participants:c.value,[`unread.${y}`]:0})}}const D=c.value.filter(b=>b!==x);await Dl(bn(Ae,"chats",s.value,"messages"),{senderId:x,senderName:i.value.displayName||i.value.email,text:n.value.trim(),timestamp:Ns(),readBy:[x]});const z=He(Ae,"chats",s.value),te={lastSenderId:x,updatedAt:Ns(),[`unread.${x}`]:0};D.forEach(b=>{te[`unread.${b}`]=cC(1)}),await Oi(z,te),n.value="",p()}function j(){u.value=!u.value}async function q(){if(!s.value||!i.value)return;const x=i.value.uid,D=`
  ...
  `.trim();await Dl(bn(Ae,"chats",s.value,"messages"),{senderId:x,senderName:i.value.displayName||i.value.email,text:D,type:"withdraw",timestamp:Ns(),readBy:[x]}),u.value=!1}return ui(at,async x=>{if(i.value=x,x&&!e.isAdmin){const D=await Qn(He(Ae,"users",x.uid));D.exists()&&(f.value.amount=D.data().balance||0),S()}}),(x,D)=>(pe(),ss(Eg,{to:"body"},[k("div",{class:"modal-overlay",onClick:D[8]||(D[8]=Ec(z=>x.$emit("close"),["self"]))},[k("div",TN,[k("div",IN,[k("h2",null,Ze(t.isAdmin?"Admin Chat":"Chat with Admin"),1),k("button",{class:"close-btn",onClick:D[0]||(D[0]=z=>x.$emit("close"))},"✖")]),t.isAdmin&&!o.value?(pe(),Ie("div",AN,[Ke(wN,{onChatSelected:_})])):o.value||s.value?(pe(),Ie("div",bN,[k("div",{class:"chat-box",ref_key:"chatBox",ref:l},[(pe(!0),Ie(ot,null,gc(r.value,z=>(pe(),Ie("div",{key:z.id,class:Tr(["message",{"my-message":z.senderId===i.value?.uid,"other-message":z.senderId!==i.value?.uid,"withdraw-message":z.type==="withdraw"}])},[z.type==="withdraw"?(pe(),Ie(ot,{key:0},[D[9]||(D[9]=_e(" 🏦 ",-1)),D[10]||(D[10]=k("strong",null,"Reward Request",-1)),D[11]||(D[11]=k("br",null,null,-1)),_e(" "+Ze(z.text),1)],64)):(pe(),Ie(ot,{key:1},[k("strong",null,Ze(z.senderName)+":",1),_e(" "+Ze(z.text),1)],64))],2))),128)),u.value?(pe(),Ie("div",RN,[D[12]||(D[12]=k("label",null,"Country:",-1)),ln(k("input",{"onUpdate:modelValue":D[1]||(D[1]=z=>f.value.country=z),placeholder:"Enter country"},null,512),[[hn,f.value.country]]),D[13]||(D[13]=k("label",null,"Currency:",-1)),ln(k("input",{"onUpdate:modelValue":D[2]||(D[2]=z=>f.value.currency=z),placeholder:"Enter currency"},null,512),[[hn,f.value.currency]]),D[14]||(D[14]=k("label",null,"Bank:",-1)),ln(k("input",{"onUpdate:modelValue":D[3]||(D[3]=z=>f.value.bank=z),placeholder:"Enter bank"},null,512),[[hn,f.value.bank]]),D[15]||(D[15]=k("label",null,"Account Number:",-1)),ln(k("input",{"onUpdate:modelValue":D[4]||(D[4]=z=>f.value.accountNumber=z),placeholder:"Enter account number"},null,512),[[hn,f.value.accountNumber]]),D[16]||(D[16]=k("label",null,"Amount:",-1)),ln(k("input",{"onUpdate:modelValue":D[5]||(D[5]=z=>f.value.amount=z),type:"number",readonly:""},null,512),[[hn,f.value.amount]]),k("div",SN,[k("button",{onClick:q,disabled:!m.value,class:Tr({disabled:!m.value})}," Submit Request ",10,CN),k("button",{onClick:D[6]||(D[6]=z=>u.value=!1)},"Cancel")])])):Bt("",!0)],512),k("div",PN,[ln(k("input",{"onUpdate:modelValue":D[7]||(D[7]=z=>n.value=z),placeholder:"Type your message...",onKeyup:lI(V,["enter"])},null,544),[[hn,n.value]]),k("button",{onClick:V},"Send"),k("button",{onClick:j},"Claim Reward")])])):Bt("",!0)])])]))}},NN=$r(kN,[["__scopeId","data-v-e1c02fab"]]),DN={class:"homepage"},VN={key:0,class:"unread-dot"},ON={class:"welcome-box"},xN={key:0,class:"user-greeting"},MN={key:1,class:"user-greeting"},LN={class:"button-group"},FN={__name:"HomePage",setup(t){const e=we(!1),n=we(!1),r=we(null),s=we(null);ui(at,async o=>{if(r.value=o,o){const c=await Qn(He(Ae,"users",o.uid));s.value=c.data()?.role||"user",i(o.uid)}});function i(o){const c=es(bn(Ae,"chats"),$s("participants","array-contains",o));_o(c,l=>{let u=!1;l.forEach(f=>{(f.data().unread?.[o]||0)>0&&(u=!0)}),n.value=u})}return(o,c)=>{const l=cs("router-link");return pe(),Ie("div",DN,[c[9]||(c[9]=k("video",{autoplay:"",muted:"",loop:"",playsinline:"",class:"background-video"},[k("source",{src:pE,type:"video/mp4"}),_e(" Your browser does not support the video tag. ")],-1)),r.value?(pe(),Ie("div",{key:0,class:"chat-icon-container",onClick:c[0]||(c[0]=u=>ql.value=!0)},[c[4]||(c[4]=k("i",{class:"fas fa-comments"},null,-1)),n.value?(pe(),Ie("span",VN)):Bt("",!0)])):Bt("",!0),Kn(ql)?(pe(),ss(NN,{key:1,isAdmin:s.value==="admin",onClose:c[1]||(c[1]=u=>ql.value=!1)},null,8,["isAdmin"])):Bt("",!0),k("div",ON,[c[7]||(c[7]=k("h1",{class:"main-title"},"Welcome to the Howell",-1)),r.value?(pe(),Ie("p",xN,"Hello, "+Ze(r.value.displayName||r.value.email),1)):(pe(),Ie("p",MN,"Please log in")),c[8]||(c[8]=k("p",{class:"description"},[_e(" Test your knowledge across subjects, people, and world events."),k("br"),_e(" Learn while having fun! ")],-1)),k("div",LN,[r.value?(pe(),ss(l,{key:0,to:"/topics"},{default:en(()=>c[5]||(c[5]=[k("button",{class:"btn green"},"Explore Topics",-1)])),_:1,__:[5]})):(pe(),ss(l,{key:1,to:"/topics"},{default:en(()=>c[6]||(c[6]=[k("button",{class:"btn blue"},"Get Started",-1)])),_:1,__:[6]})),k("button",{class:"btn orange",onClick:c[2]||(c[2]=u=>e.value=!0)},"Privacy & Rules")])]),Ke(dN,{open:e.value,onClose:c[3]||(c[3]=u=>e.value=!1)},null,8,["open"])])}}},UN=$r(FN,[["__scopeId","data-v-87b9a3c6"]]),$N={class:"login-container"},BN={class:"login-box"},qN={key:0,class:"consent-overlay"},jN={class:"consent-box"},HN={class:"signup-link"},zN={__name:"LoginPage",setup(t){const e=Qc(),n=we(""),r=we(""),s=we(!1),i=async()=>{try{await a0(at,n.value,r.value),e.push("/")}catch(c){alert(c.message)}},o=async()=>{s.value=!1;const c=new nn;c.addScope("email");try{const u=(await Rv(at,c)).user;await as(He(Ae,"users",u.uid),{uid:u.uid,name:u.displayName||"",email:u.email||"",photoURL:u.photoURL||"",lastLogin:new Date},{merge:!0}),e.push("/")}catch(l){console.error("Facebook login failed:",l),alert("Facebook sign-in failed. Please try again.")}};return(c,l)=>{const u=cs("router-link");return pe(),Ie("div",$N,[k("div",BN,[l[10]||(l[10]=k("h2",null,"Login",-1)),k("form",{onSubmit:Ec(i,["prevent"])},[l[4]||(l[4]=k("label",null,"Email",-1)),ln(k("input",{type:"email","onUpdate:modelValue":l[0]||(l[0]=f=>n.value=f),required:""},null,512),[[hn,n.value]]),l[5]||(l[5]=k("label",null,"Password",-1)),ln(k("input",{type:"password","onUpdate:modelValue":l[1]||(l[1]=f=>r.value=f),required:""},null,512),[[hn,r.value]]),l[6]||(l[6]=k("button",{type:"submit",class:"primary-btn"},"Login",-1))],32),k("button",{class:"facebook-btn",onClick:l[2]||(l[2]=f=>s.value=!0)}," Continue with Facebook "),s.value?(pe(),Ie("div",qN,[k("div",jN,[l[7]||(l[7]=k("p",null,"We’ll open a small Facebook window so you can continue your login securely.",-1)),k("button",{class:"primary-btn",onClick:o},"Continue"),k("button",{class:"cancel-btn",onClick:l[3]||(l[3]=f=>s.value=!1)},"Cancel")])])):Bt("",!0),k("p",HN,[l[9]||(l[9]=_e(" Don’t have an account? ",-1)),Ke(u,{to:"/signup"},{default:en(()=>l[8]||(l[8]=[_e("Sign up",-1)])),_:1,__:[8]})])])])}}},WN=$r(zN,[["__scopeId","data-v-c6e73517"]]),KN={class:"signup-container"},GN={class:"signup-box"},QN={class:"login-link"},YN={__name:"SignupPage",setup(t){const e=Qc(),n=we(""),r=we(""),s=we(""),i=async()=>{try{const c=await o0(at,r.value,s.value);await l0(c.user,{displayName:n.value}),await as(He(Ae,"users",c.user.uid),{uid:c.user.uid,name:n.value,email:r.value,photoURL:"",correct:0,question:0,timeSpent:0,balance:0,rank:0,questionNo:[],score:0,createdAt:new Date}),e.push("/")}catch(c){alert(c.message)}},o=async()=>{const c=new nn;c.addScope("email");try{const u=(await Rv(at,c)).user;await as(He(Ae,"users",u.uid),{uid:u.uid,name:u.displayName||"",email:u.email||"",phone:"",photoURL:u.photoURL||"",correct:0,question:0,timeSpent:0,balance:0,rank:0,questionNo:[],score:0,createdAt:new Date},{merge:!0}),e.push("/")}catch(l){const u=l?.code||"";if(u==="auth/popup-blocked"||u==="auth/popup-closed-by-user"||u==="auth/web-storage-unsupported")try{await Pv(at,c)}catch(f){console.error("Redirect sign-in failed:",f),alert("Facebook sign-in failed. Please try again.")}else console.error("Facebook signup failed:",l),alert("Facebook sign-in failed. Please try again.")}};return un(async()=>{try{const c=await kv(at);if(c&&c.user){const l=c.user;await as(He(Ae,"users",l.uid),{uid:l.uid,name:l.displayName||"",email:l.email||"",phone:"",photoURL:l.photoURL||"",correct:0,question:0,timeSpent:0,balance:0,rank:0,questionNo:[],score:0,createdAt:new Date},{merge:!0}),e.push("/")}}catch(c){console.debug("No redirect result or redirect sign-in failed:",c?.code||c)}}),(c,l)=>{const u=cs("router-link");return pe(),Ie("div",KN,[k("div",GN,[l[9]||(l[9]=k("h2",null,"Sign Up",-1)),k("form",{onSubmit:Ec(i,["prevent"])},[l[3]||(l[3]=k("label",null,"Name",-1)),ln(k("input",{type:"text","onUpdate:modelValue":l[0]||(l[0]=f=>n.value=f),required:""},null,512),[[hn,n.value]]),l[4]||(l[4]=k("label",null,"Email",-1)),ln(k("input",{type:"email","onUpdate:modelValue":l[1]||(l[1]=f=>r.value=f),required:""},null,512),[[hn,r.value]]),l[5]||(l[5]=k("label",null,"Password",-1)),ln(k("input",{type:"password","onUpdate:modelValue":l[2]||(l[2]=f=>s.value=f),required:""},null,512),[[hn,s.value]]),l[6]||(l[6]=k("button",{type:"submit",class:"primary-btn"},"Sign Up",-1))],32),k("button",{class:"facebook-btn",onClick:o},"Continue with Facebook"),k("p",QN,[l[8]||(l[8]=_e(" Already have an account? ",-1)),Ke(u,{to:"/login"},{default:en(()=>l[7]||(l[7]=[_e("Log in",-1)])),_:1,__:[7]})])])])}}},JN=$r(YN,[["__scopeId","data-v-6cc1e260"]]),XN={class:"page-container"},ZN={key:0,class:"login-notice"},eD={class:"topic-grid"},tD={class:"topic-header"},nD={class:"topic-title"},rD={key:0,class:"competition-badge"},sD={class:"topic-description"},iD={key:1,class:"play-button disabled",disabled:"",title:"Login to participate"},oD={__name:"TopicSelectionPage",setup(t){const e=we(null);ui(at,o=>{e.value=o});const n=[{id:"messi",title:"Lionel Messi",description:"How well do you know Li@nel M6ssi?",isCompetition:!0},{id:"cristiano",title:"CR7",description:"How well do you know Cristiano Ronaldo?",isCompetition:!0},{id:"lamine",title:"Lamine Yamal",description:"How well do you know the wonder kid?"},{id:"biology",title:"Biology",description:"Test your knowledge of life, cells, plants, and more."},{id:"history",title:"History",description:"Learn from the past to win the present!"},{id:"english",title:"English",description:"Master vocabulary, grammar, and comprehension."},{id:"chemistry",title:"Chemistry",description:"How well do you know chemistry."},{id:"economics",title:"Economics",description:"Supply, demand, money & the markets!"}],r=o=>o.isCompetition?`/competition/${o.id}`:`/play/${o.id}`,s=Ft(()=>[...n].sort((o,c)=>o.isCompetition&&!c.isCompetition?-1:!o.isCompetition&&c.isCompetition?1:0)),i=o=>({messi:"#007BFF",cristiano:"#ff9900ff",lamine:"#044112ff",biology:"#28A745",maths:"#73ae50ff",history:"#343A40",english:"#6C757D",economics:"#17A2B8",chemistry:"#0a3238ff"})[o]||"#007BFF";return un(()=>{const o=document.getElementById("adsterra-bottom-banner");o&&(o.innerHTML=`
      ...
      <\/script>
      <script type="text/javascript" src="//www.highperformanceformat.com/d67c97eede17bd8ce9634a0cfbb2f097/invoke.js"><\/script>
    `)}),(o,c)=>{const l=cs("router-link");return pe(),Ie(ot,null,[k("div",XN,[c[2]||(c[2]=k("video",{autoplay:"",muted:"",loop:"",playsinline:"",class:"background-video"},[k("source",{src:pE,type:"video/mp4"}),_e(" Your browser does not support the video tag. ")],-1)),c[3]||(c[3]=k("h2",{class:"page-title"},"Select a Topic",-1)),e.value?Bt("",!0):(pe(),Ie("div",ZN,c[0]||(c[0]=[k("p",null,"Login to participate in competition",-1)]))),k("div",eD,[(pe(!0),Ie(ot,null,gc(s.value,u=>(pe(),Ie("div",{key:u.id,class:"topic-card",style:cc({backgroundColor:i(u.id)})},[k("div",tD,[k("h3",nD,Ze(u.title),1),u.isCompetition?(pe(),Ie("span",rD,"Competition")):Bt("",!0)]),k("p",sD,Ze(u.description),1),!u.isCompetition||e.value?(pe(),ss(l,{key:0,to:r(u)},{default:en(()=>c[1]||(c[1]=[k("button",{class:"play-button"},"Play Now",-1)])),_:2,__:[1]},1032,["to"])):(pe(),Ie("button",iD," Play Now "))],4))),128))])]),c[4]||(c[4]=k("div",{id:"adsterra-bottom-banner"},null,-1))],64)}}},aD=$r(oD,[["__scopeId","data-v-921d74a5"]]),cD=[{path:"/",component:UN},{path:"/login",component:WN},{path:"/signup",component:JN},{path:"/policies",name:"Policies",component:()=>jl(()=>import("./Policies-D1jEeLZE.js"),__vite__mapDeps([0,1]),import.meta.url)},{path:"/topics",component:aD,meta:{requiresAuth:!1}},{path:"/play/:topicId",name:"PlayTopic",component:()=>jl(()=>import("./QuestionCarousel-BKy5wk_P.js"),__vite__mapDeps([2,3,4]),import.meta.url),props:!0,meta:{requiresAuth:!1}},{path:"/competition/:topicId",name:"Competition",component:()=>jl(()=>import("./Competition-ChLZ-96Q.js"),__vite__mapDeps([5,3,6]),import.meta.url),props:!0,meta:{requiresAuth:!0}},{path:"/:catchAll(.*)",redirect:"/"}],mE=Qk({history:Ak(),routes:cD});mE.beforeEach((t,e,n)=>{const r=at.currentUser;t.matched.some(i=>i.meta.requiresAuth)&&!r?n("/login"):n()});const lD=""+new URL("result-DZ1DfWHF.png",import.meta.url).href,uD=""+new URL("quiz-result-CizZnYdT.png",import.meta.url).href,hD=[lD,uD];we(0);const Yc=document.createElement("div");Yc.id="loading-screen";Yc.style=`
  position: fixed;
  inset: 0;
  background: #1e1e1e;
  color: #fff;
